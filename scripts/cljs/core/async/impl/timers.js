...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_24227 = (0);while(true){
if((i_24227 < arr.length))
{(arr[i_24227] = null);
{
var G__24228 = (i_24227 + (1));
i_24227 = G__24228;
continue;
}
} else
...
{var i_24240 = (self__.level + (1));while(true){
if((i_24240 <= (new_level + (1))))
{(update[i_24240] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_24242 = (0);while(true){
if((i_24242 <= self__.level))
{var links_24243 = (update[i_24242]).forward;if(((links_24243[i_24242]) === x__$1))
{(links_24243[i_24242] = (x__$1.forward[i_24242]));
{
var G__24244 = (i_24242 + (1));
i_24242 = G__24244;
continue;
}
} else
{{
var G__24245 = (i_24242 + (1));
i_24242 = G__24245;
continue;
}
}
