...
{return s.replace((new RegExp((function (){var G__24934 = match;return goog.string.regExpEscape(G__24934);
})(),"g")),replacement);
} else
...
{{
var G__24935 = cljs.core.pop(v__$1);
v__$1 = G__24935;
continue;
}
} else
...
{var pred__24943 = cljs.core._EQ_;var expr__24944 = limit;if(cljs.core.truth_((function (){var G__24946 = (1);var G__24947 = expr__24944;return (pred__24943.cljs$core$IFn$_invoke$arity$2 ? pred__24943.cljs$core$IFn$_invoke$arity$2(G__24946,G__24947) : pred__24943.call(null,G__24946,G__24947));
})()))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_((function (){var G__24948 = (2);var G__24949 = expr__24944;return (pred__24943.cljs$core$IFn$_invoke$arity$2 ? pred__24943.cljs$core$IFn$_invoke$arity$2(G__24948,G__24949) : pred__24943.call(null,G__24948,G__24949));
})()))
...
var G__24953 = s__$1.substring((index + cljs.core.count(m)));
var G__24954 = (limit__$1 - (1));
var G__24955 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring((0),index));
s__$1 = G__24953;
limit__$1 = G__24954;
parts = G__24955;
continue;
...
*/
clojure.string.trim = (function trim(s){var G__24957 = s;return goog.string.trim(G__24957);
});
/**
* Removes whitespace from the left side of string.
*/
clojure.string.triml = (function triml(s){var G__24959 = s;return goog.string.trimLeft(G__24959);
});
/**
* Removes whitespace from the right side of string.
*/
clojure.string.trimr = (function trimr(s){var G__24961 = s;return goog.string.trimRight(G__24961);
});
/**
...
*/
clojure.string.blank_QMARK_ = (function blank_QMARK_(s){var G__24964 = s;return goog.string.isEmptySafe(G__24964);
});
/**
...
{var ch = s.charAt(index);var temp__4124__auto___24965 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);if(cljs.core.truth_(temp__4124__auto___24965))
{var replacement_24966 = temp__4124__auto___24965;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_24966)));
} else
{buffer.append(ch);
}
{
var G__24967 = (index + (1));
index = G__24967;
continue;
}
}
